...
> A .gitignore file lists the files and directories you do _not_ want under source control, such as hidden files, secure credentials, venv and test directories, etc.
