...
Know that venv is not the only method of setting up virtual environments, but is the official suggested method by the folks at python.org.
...
After installing dependencies use pip freeze > requirements.txt to list the requirements and version numbers for that project.
